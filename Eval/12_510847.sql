...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2020 a las 21:44:00
...
--
-- Estructura de tabla para la tabla `sgi_docu_semi`
--

CREATE TABLE `sgi_docu_semi` (
  `DSEM_CODI` int(11) NOT NULL,
  `DSEM_SEM_CODI` int(11) NOT NULL,
  `DSEM_NOMB` varchar(500) NOT NULL,
  `DSEM_FECH_INIC` date NOT NULL,
  `DSEM_FECH_TERM` date DEFAULT NULL,
  `DSEM_PATH` varchar(500) DEFAULT NULL
...
CREATE TABLE `sgi_esproy_semi` (
  ...
  `ESPROYS_NOMB` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sgi_esproy_semi` (`ESPROYS_CODI`, `ESPROYS_NOMB`) VALUES
(1, 'INICIO'),
(2, 'EN EJECUCION'),
(3, 'TERMINADO');
...
(12, '', 'COL', 'GRUPO', 3, NULL, 2, NULL, 56, 'CIE', 1, '0000-00-00', '2020-04-07');
...
CREATE TABLE `sgi_inve_semi` (
  ...
  `ins_line_inve_codi` int(11) DEFAULT NULL,
...
CREATE TABLE `sgi_line_inve_semi` (
  ...
  `LIS_FECH_INI` date NOT NULL,
  `LIS_FECH_TERM` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Estructura de tabla para la tabla `sgi_proy_prod_semi`
--

CREATE TABLE `sgi_proy_prod_semi` (
  `PPR_CODI` int(11) NOT NULL,
  `PPR_SEMI_CODI` int(11) NOT NULL,
  `PPR_INVE_CODI` int(11) NOT NULL,
  `PPR_PROY_CODI` int(11) NOT NULL,
  `PPR_PROD_CODI` int(11) NOT NULL,
  `PPR_EPD_CODI` int(11) NOT NULL,
  `PPR_EPY_CODI` int(11) NOT NULL,
  `PPR_FECH_INIC` date NOT NULL,
  `PPR_FECH_TERM` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'SEMILLERO', NULL, 0, '2020-01-01', NULL, '', 'xx', '', 'xx', '', 'xxxx', '', '', '', 'xxx', '', '', '', '', '', '', NULL),
(12, 'SEMILLERO2', 3, 1, '2020-06-08', NULL, 'fd', 'fd', '', 'fdf', '', 'fdfd', '', '', '', 'fdf', '', '', '', '', '', '', NULL),
(13, 'SEMILLERO3', 3, 1, '2020-06-08', NULL, 'ds', 'ds', '', 'ds', '', 'dsd', '', '', '', 'ds', '', '', '', '', '', '', NULL),
(14, 'SEMILLERO4', 3, 0, '2020-06-08', NULL, 'ds', 'ds', '', '', '', 'ds', '', '', '', '', '', '', '', '', '', '', NULL);
...
--
-- Indices de la tabla `sgi_docu_semi`
--
ALTER TABLE `sgi_docu_semi`
  ADD PRIMARY KEY (`DSEM_CODI`),
  ADD KEY `DSEM_SEM_CODI` (`DSEM_SEM_CODI`);
...
ALTER TABLE `sgi_line_inve_semi`
  ADD PRIMARY KEY (`LIS_CODI`),
  ADD KEY `LIS_LINE_INVE_CODI` (`LIS_LINE_INVE_CODI`),
...
--
-- Indices de la tabla `sgi_proy_prod_semi`
--
ALTER TABLE `sgi_proy_prod_semi`
  ADD PRIMARY KEY (`PPR_CODI`),
  ADD KEY `PPR_INVE_CODI` (`PPR_INVE_CODI`),
  ADD KEY `PPR_SEMI_CODI` (`PPR_SEMI_CODI`),
  ADD KEY `PPR_PROY_CODI` (`PPR_PROY_CODI`),
  ADD KEY `PPR_PROD_CODI` (`PPR_PROD_CODI`),
  ADD KEY `PPR_EPD_CODI` (`PPR_EPD_CODI`),
  ADD KEY `PPR_EPY_CODI` (`PPR_EPY_CODI`);
...
--
-- AUTO_INCREMENT de la tabla `sgi_docu_semi`
--
ALTER TABLE `sgi_docu_semi`
  MODIFY `DSEM_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `sgi_inve_semi`
--
ALTER TABLE `sgi_inve_semi`
  MODIFY `INS_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `sgi_line_inve_semi`
--
ALTER TABLE `sgi_line_inve_semi`
  MODIFY `LIS_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sgi_prog_acad_semi`
  MODIFY `PAS_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `sgi_proy_prod_semi`
--
ALTER TABLE `sgi_proy_prod_semi`
  MODIFY `PPR_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `sgi_semi`
--
ALTER TABLE `sgi_semi`
  MODIFY `SEM_CODI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Filtros para la tabla `sgi_docu_semi`
--
ALTER TABLE `sgi_docu_semi`
  ADD CONSTRAINT `sgi_docu_semi_ibfk_1` FOREIGN KEY (`DSEM_SEM_CODI`) REFERENCES `sgi_semi` (`SEM_CODI`);
...
--
ALTER TABLE `sgi_inve_semi`
  ADD CONSTRAINT `sgi_inve_semi_ibfk_1` FOREIGN KEY (`INS_INVE_IDEN`) REFERENCES `sgi_inve` (`INV_CODI`),
  ADD CONSTRAINT `sgi_inve_semi_ibfk_2` FOREIGN KEY (`INS_SEMI_CODI`) REFERENCES `sgi_semi` (`SEM_CODI`),
...
--
-- Filtros para la tabla `sgi_proy_prod_semi`
--
ALTER TABLE `sgi_proy_prod_semi`
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_1` FOREIGN KEY (`PPR_INVE_CODI`) REFERENCES `sgi_inve` (`INV_CODI`),
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_2` FOREIGN KEY (`PPR_SEMI_CODI`) REFERENCES `sgi_semi` (`SEM_CODI`),
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_3` FOREIGN KEY (`PPR_PROY_CODI`) REFERENCES `sgi_proy` (`PRO_CODI`),
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_4` FOREIGN KEY (`PPR_PROD_CODI`) REFERENCES `sgi_prod` (`Id`),
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_5` FOREIGN KEY (`PPR_EPD_CODI`) REFERENCES `sgi_esprod_semi` (`ESPRODS_CODI`),
  ADD CONSTRAINT `sgi_proy_prod_semi_ibfk_6` FOREIGN KEY (`PPR_EPY_CODI`) REFERENCES `sgi_esproy_semi` (`ESPROYS_CODI`);
